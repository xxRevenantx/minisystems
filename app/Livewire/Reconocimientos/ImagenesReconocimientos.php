...
class ImagenesReconocimientos extends Component
{
    ...
    public function guardarImagenReconocimiento(): void
    {
        ...
        ReconocimientoImagen::create([
            ...
            'nombre' => trim($this->descripcion),
            'descripcion' => trim($this->descripcion),
            'orientacion' => 'horizontal',
            'configuracion' => ['nombre' => ['top' => 250, 'tamano' => 34], 'descripcion' => ['top' => 330, 'tamano' => 16], 'fecha' => ['top' => 470], 'firmas' => ['top' => 540]],
            'activo' => true,
        ]);
    ...
    public function actualizarImagenReconocimiento(): void
    {
        ...
        $img->nombre = trim($this->descripcionEdit);
        $img->descripcion = trim($this->descripcionEdit);
        $img->save();
        $this->dispatch('swal', ['title' => 'Diseño actualizado', 'icon' => 'success', 'position' => 'top-end']);
        $this->closeModal();
    }
