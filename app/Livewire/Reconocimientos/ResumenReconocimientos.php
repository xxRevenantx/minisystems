    ...
    public function render()
    {
        return view('livewire.reconocimientos.resumen-reconocimientos', [
            'stats' => [
                ...
                'mes' => Reconocimiento::whereBetween('created_at', [now()->startOfMonth(), now()->endOfMonth()])->count(),
                'revision' => Reconocimiento::where('estado', 'revision')->count(),
                'aprobados' => Reconocimiento::where('estado', 'aprobado')->count(),
                'entregados' => Reconocimiento::where('estado', 'entregado')->count(),
                'cancelados' => Reconocimiento::where('estado', 'cancelado')->count(),
            ],
