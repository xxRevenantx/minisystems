...
<div
    x-data="imageOptimizerUploader(<?php echo \Illuminate\Support\Js::from($uploaderConfig)->toHtml() ?>)"
    class="space-y-6"
>
    <section
        ...
        <div class="relative flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-2">
                ...
                <div class="rounded-2xl border border-white/15 bg-white/10 px-4 py-3 backdrop-blur">
                    ...
                    <p class="mt-1 text-sm font-black"><?php echo e($retentionHours); ?> horas</p>
                </div>
            </div>
        </div>
    </section>
...
<?php endif; ?>
                        ...
                        >
                            <?php echo e($selectedProfile['description']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::input.index','data' => ['wire:model' => 'targetKb','type' => 'number','min' => '50','max' => '20000','step' => '10','label' => 'Peso objetivo (KB)','placeholder' => 'Opcional']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'targetKb','type' => 'number','min' => '50','max' => '20000','step' => '10','label' => 'Peso objetivo (KB)','placeholder' => 'Opcional']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
