        ...
        <header class="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
            ...
            <nav class="flex flex-wrap gap-2 rounded-2xl border border-neutral-200 bg-white p-1.5 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                <a href="<?php echo e(route('images')); ?>" wire:navigate
                    class="inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-black transition <?php echo e($section === 'processor' ? 'bg-blue-600 text-white shadow-md shadow-blue-500/20' : 'text-neutral-600 hover:bg-blue-50 hover:text-blue-700 dark:text-neutral-300 dark:hover:bg-blue-950/30 dark:hover:text-blue-300'); ?>">
                    Procesar imágenes
                </a>
                <a href="<?php echo e(route('images.optimizer')); ?>" wire:navigate
                    class="inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-black transition <?php echo e($section === 'optimizer' ? 'bg-emerald-600 text-white shadow-md shadow-emerald-500/20' : 'text-neutral-600 hover:bg-emerald-50 hover:text-emerald-700 dark:text-neutral-300 dark:hover:bg-emerald-950/30 dark:hover:text-emerald-300'); ?>">
                    Optimizar imágenes
                </a>
                <a href="<?php echo e(route('images.social-ai')); ?>" wire:navigate
                    class="inline-flex items-center justify-center rounded-xl px-4 py-2.5 text-sm font-black transition <?php echo e($section === 'social-ai' ? 'bg-violet-600 text-white shadow-md shadow-violet-500/20' : 'text-neutral-600 hover:bg-violet-50 hover:text-violet-700 dark:text-neutral-300 dark:hover:bg-violet-950/30 dark:hover:text-violet-300'); ?>">
                    ✨ Redacción IA
                </a>
...
?>
        <?php elseif($section === 'social-ai'): ?>
            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('images.social-ai-composer', []);
