...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::field','data' => ['class' => 'space-y-2','wire:key' => 'tinymce-field-'.e($editorId).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'space-y-2','wire:key' => 'tinymce-field-'.e($editorId).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::label','data' => ['for' => ''.e($editorId).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => ''.e($editorId).'']); ?><?php echo e($label); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'sm','color' => 'zinc']); ?><?php echo e($badge); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
    ...
    <div
        ...
        x-data="miniSystemsTinyMce({
            editorId: <?php echo \Illuminate\Support\Js::from($editorId)->toHtml() ?>,
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::textarea','data' => ['id' => ''.e($editorId).'','xRef' => 'textarea','wire:model.live.debounce.400ms' => ''.e($model).'','class' => 'min-h-56 w-full resize-y border-0! bg-transparent! text-sm','placeholder' => ''.e($placeholder).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => ''.e($editorId).'','x-ref' => 'textarea','wire:model.live.debounce.400ms' => ''.e($model).'','class' => 'min-h-56 w-full resize-y border-0! bg-transparent! text-sm','placeholder' => ''.e($placeholder).'']); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\minisystems\resources\views/components/tinymce-editor.blade.php ENDPATH**/ ?>