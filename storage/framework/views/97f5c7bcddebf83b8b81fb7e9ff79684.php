...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => __('MiniSystems - Marcos adaptables')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('MiniSystems - Marcos adaptables'))]); ?>
...
[$__name, $__params] = $__split('images.creacion-marcos', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1669557066-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\minisystems\resources\views/marcos/index.blade.php ENDPATH**/ ?>